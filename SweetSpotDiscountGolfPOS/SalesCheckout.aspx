	...
	<div>
		...
		<asp:Panel ID="pnlDefaultButton" runat="server" DefaultButton="mopCash">
			<asp:Table runat="server">
					...
					<asp:TableCell ColumnSpan="2" CssClass="auto-style1">
						<asp:Table runat="server">
							...
							<asp:TableRow>
								...
								<asp:TableCell>
									<asp:TextBox ID="txtAmountPaying" runat="server" AutoCompleteType="Disabled" Width="159px" />
								</asp:TableCell>
							</asp:TableRow>
						</asp:Table>
					</asp:TableCell>
				...
				Comments: <br /><asp:TextBox ID="txtComments" runat="server" TextMode="MultiLine" AutoCompleteType="Disabled" />
