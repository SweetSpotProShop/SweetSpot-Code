        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    if (startDate == endDate) { lblDates.Text = "Grips Sold through: " + startDate.ToString("d"); }
                    else { lblDates.Text = "Grips sold through: " + startDate.ToString("d") + " to " + endDate.ToString("d"); }
                    grdStats.DataSource = R.returnSpecificGripDataTableForReport(startDate, endDate, objPageDetails);
                    grdStats.DataBind();
                }
            }
            //Exception catch
