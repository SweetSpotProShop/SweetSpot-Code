...
namespace SweetSpotDiscountGolfPOS.FP
{
    public class ImportExport
    {
        ...
        {
            string sqlCmd = "SELECT '' AS Vendor, (SELECT varLocationName FROM tbl_location L WHERE L.intLocationID = C.intLocationID) AS varLocationName, "
        ...
        {
            string sqlCmd = "SELECT '' AS Vendor, (SELECT varLocationName FROM tbl_location L WHERE L.intLocationID = A.intLocationID) AS varLocationName, "
                ...
                + "0 AS bitIsUsedProduct FROM tbl_accessories A";
            return sqlCmd;
        }
        private string ExportClothingString()
        {
            string sqlCmd = "SELECT '' AS Vendor, (SELECT varLocationName FROM tbl_location L WHERE L.intLocationID = CL.intLocationID) AS varLocationName, "
                ...
                + "IT.intItemTypeID = CL.intItemTypeID) AS itemType, 0 AS bitIsUsedProduct FROM tbl_clothing CL";
            return sqlCmd;
        }
