    ...
    public class InvoiceManager
    {
        ...
        private void InsertReceiptIntoFinalTable(Invoice receipt, object[] objPageDetails)
        {
            ...
            object[][] parms =
            {
                ...
                new object[] { "@intCustomerID", receipt.intCustomerID },
                new object[] { "@intEmployeeID", receipt.intEmployeeID },
                new object[] { "@intLocationID", receipt.intLocationID },
        ...
        public void CreateNewInvoiceAtTable(string pressedBTN, CurrentUser cu, object[] objPageDetails)
        {
            ...
            Invoice newInvoice = new Invoice
            {
                ...
                intCustomerID = 1, //CM.ReturnGuestCustomerForLocation(cu, objPageDetails)[0];
