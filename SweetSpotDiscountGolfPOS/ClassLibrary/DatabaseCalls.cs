...
namespace SweetSpotDiscountGolfPOS
{
    public class DatabaseCalls
    {
        ...
        public DataTable returnDataTableData(string sqlCmd, object[][] parms)
        {
        ...
        public DataTable returnDataTableDataFromArrayLists(string sqlCmd, ArrayList parms, ArrayList search)
        {
        ...
        //**Always Keep active, Below is tracking query strings addition
